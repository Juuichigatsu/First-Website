...
(function ($) {
	...
	var ytubelightbox = '<div class="videobox">' + '<div class="centeredchild">' + '<div class="videowrapper">' + '<div id="videoplayer"></div>' + '</div>' + '</div>' + '</div>'
	...
	jQuery.fn.youtubegallery = function (options) {
		...
		return this.each(function () { //return jQuery obj
				...
				$lis.each(function (i) {
					...
					$li.html('<div class="thumbwrap">' + '<img src="' + thumbnail + '" />' + '<div class="panel"><div class="panelinner"><i class="play fa fa-play"></i> <a class="externallink fa fa-external-link-square" href="' + doclink + '"></a></div></div>' + '</div>'
